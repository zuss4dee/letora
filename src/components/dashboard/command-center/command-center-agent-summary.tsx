      ...
      <div className="grid grid-cols-2 gap-4">
        {Array.from({ length: 4 }, (_, idx) => (
          <div
            ...
            className="h-20 rounded-sm bg-zinc-100 dark:bg-zinc-900 md:border md:border-zinc-200 md:dark:border-[#333333]"
          />
        ))}
      </div>
    </div>
...
export async function CommandCenterAgentSummary({ userId }: { userId: string }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col border border-zinc-200 bg-white p-4 dark:border-[#333333] dark:bg-[#161616]">

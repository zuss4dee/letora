...
export function PropertyIntelligenceDock({ insight }: { insight: string }) {
  ...
  return (
    <div className="fixed bottom-10 right-6 z-40 w-[min(100vw-3rem,20rem)] border-b border-[#BD9952] bg-[#252626]/80 p-6 shadow-2xl backdrop-blur-xl md:bottom-12 md:right-12">

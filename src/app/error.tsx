...
export default function Error({
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#131313] px-6 py-16 text-center text-foreground">
      ...
      <div className="relative z-10 mx-auto max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center justify-center gap-3 pt-2 sm:flex-row">
          ...
          <Link
            href="/dashboard"
            className="inline-flex min-w-[140px] items-center justify-center rounded-md border border-[rgb(72_72_72_/0.4)] bg-transparent px-5 py-2.5 font-[family-name:var(--font-inter)] text-sm font-medium text-foreground transition-colors hover:bg-[#1b1b1b]"
          >
            Go to dashboard
          </Link>
        </div>

export default function ComplianceLoading() {
  return (
    <div className="@container/main relative flex min-h-0 flex-1 flex-col">
      <div
        className="pointer-events-none absolute inset-x-0 top-0 z-0 h-[min(48vh,480px)] overflow-hidden"
        aria-hidden
      >
        <div className="absolute inset-x-0 top-0 h-full bg-[radial-gradient(ellipse_80%_60%_at_50%_-15%,rgba(189,153,82,0.12),transparent_62%)]" />
      </div>
      <div className="relative z-10 mx-auto w-full max-w-7xl flex-1 px-4 py-10 md:px-8 md:py-12 lg:px-12">

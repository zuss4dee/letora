...
export default async function ApprovalsPage({
  ...
  return (
    <div className="@container/main flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-background dark:bg-[#f8f8f7] text-zinc-950 dark:bg-[#0B0B0B] dark:text-zinc-100">

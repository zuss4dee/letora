...
export default async function TenanciesPage({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-background p-4 text-zinc-950 dark:bg-[#0B0B0B] dark:text-zinc-100 lg:p-8">
      {/* A. Page Header */}
...
async function AddTenancyLink() {
  ...
  return (
    <AddTenancyDialog
      ...
      trigger={
        <button className="bg-white px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-black transition-colors hover:bg-zinc-200 dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-800">
          Add Tenancy
        </button>
      }
    />

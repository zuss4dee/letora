...
async function RentTrackerAsyncSection({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      />
      {propertyId ? (
        <div className="shrink-0 border-b border-zinc-200/80 bg-white px-4 py-2 dark:border-[#282828] dark:bg-zinc-900 md:px-6">
...
function RentTrackerLoadingShell({ todayIso }: { todayIso: string }) {
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto bg-background font-['Inter',system-ui,sans-serif] text-zinc-950 dark:bg-zinc-950 dark:text-[#e6e3e1]">
      <div className="border-b border-zinc-200/80 bg-white px-4 py-5 dark:border-[#282828] dark:bg-zinc-900 md:px-6">

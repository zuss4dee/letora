...
- **Redirect URL:** Add your app origin plus `/auth/callback` (e.g. `https://app.example.com/auth/callback`) under **Authentication → URL configuration → Redirect URLs** in the Supabase dashboard.
